...
const Birthday  = () => {
    ...
    <div className="birthday">
        ...
        <p>
        <Latex>It is the $16$th prime number. It is a balanced prime (average of the previous prime ($47$) and the next prime ($59$)) and a Sophie Germain prime ($2 \times 53 + 1 = 107$ is also a prime). </Latex>
        </p>
